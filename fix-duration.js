...
const regex = /\{\/\* Right Column: Visual AI Prompt \/ Action \*\/\}\s*<div className="flex-1 bg-\[#111318\] p-5 sm:p-6 relative">\s*<div className="absolute top-2 right-4 text-\[10px\] font-mono text-slate-500">\s*\{scene\.duration\}с\s*<\/div>/g;

const replaceWith = `{\/\* Right Column: Visual AI Prompt \/ Action \*\/}
